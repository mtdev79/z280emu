 ...
 **********************************************************/
OP(dded,00) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,01) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,02) { EASP16(cpustate); cpustate->_IX = cpustate->ea;                 } /* LDA IX,(SP+w)    */
OP(dded,03) { illegal_2(cpustate); ed_03(cpustate);                           } /* LD '(SP+w),A     */
...
OP(dded,08) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,09) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,0a) { EAHX(cpustate); cpustate->_IX = cpustate->ea;                   } /* LDA IX,(HL+IX)   */
OP(dded,0b) { illegal_2(cpustate); ed_0b(cpustate);                            } /* LD '(HL+IX),A    */
...
OP(dded,10) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,11) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,12) { EAHY(cpustate); cpustate->_IX = cpustate->ea;                   } /* LDA IX,(HL+IY)   */
OP(dded,13) { illegal_2(cpustate); ed_13(cpustate);                            } /* LD '(HL+IY),A    */
...
OP(dded,18) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,19) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,1a) { EAXY(cpustate); cpustate->_IX = cpustate->ea;                   } /* LDA IX,(IX+IY)   */
OP(dded,1b) { illegal_2(cpustate); ed_1b(cpustate);                            } /* LD '(IX+IY),A    */
...
OP(dded,20) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,21) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,22) { EARA(cpustate); cpustate->_IX = cpustate->ea;                   } /* LDA IX,(ra)      */
OP(dded,23) { illegal_2(cpustate); ed_23(cpustate);                            } /* LD '(ra),A       */
...
OP(dded,28) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,29) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,2a) { EAX16(cpustate); cpustate->_IX = cpustate->ea;                  } /* LDA IX,(IX+w)    */
OP(dded,2b) { illegal_2(cpustate); ed_2b(cpustate);                            } /* LD '(IX+w),A     */
...
OP(dded,30) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,31) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,32) { EAY16(cpustate); cpustate->_IX = cpustate->ea;                  } /* LDA IX,(IY+w)    */
OP(dded,33) { illegal_2(cpustate); ed_33(cpustate);                            } /* LD '(IY+w),A     */
...
OP(dded,38) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,39) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,3a) { EAH16(cpustate); cpustate->_IX = cpustate->ea;                  } /* LDA IX,(HL+w)    */
OP(dded,3b) { illegal_2(cpustate); ed_3b(cpustate);                            } /* LD '(HL+w),A     */
...
OP(dded,40) { union PAIR tmp; EASP16(cpustate); tmp.b.l = IN(cpustate, cpustate->_BC); WM(cpustate, cpustate->ea, tmp.b.l); cpustate->_F = (cpustate->_F & CF) | SZP[tmp.b.l]; } /* IN (SP+w),(C)    */
OP(dded,41) { EASP16(cpustate); OUT(cpustate, cpustate->_BC, RM(cpustate, cpustate->ea)); } /* OUT (C),(SP+w)   */
OP(dded,42) { SBC16( IX, cpustate->_BC );                                            } /* SBC  IX,BC       */
OP(dded,43) { illegal_2(cpustate); ed_43(cpustate);                            } /* LD   '(w),BC     */
OP(dded,44) { illegal_2(cpustate); ed_44(cpustate);                            } /* NEG  'A          */
OP(dded,45) { illegal_2(cpustate); ed_45(cpustate);                            } /* RETN '           */
OP(dded,46) { illegal_2(cpustate); ed_46(cpustate);                            } /* IM   '0          */
OP(dded,47) { illegal_2(cpustate); ed_47(cpustate);                            } /* LD   'I,A        */

OP(dded,48) { union PAIR tmp; EAHX(cpustate); tmp.b.l = IN(cpustate, cpustate->_BC); WM(cpustate, cpustate->ea, tmp.b.l); cpustate->_F = (cpustate->_F & CF) | SZP[tmp.b.l]; } /* IN (HL+IX),(C)    */
OP(dded,49) { EAHX(cpustate); OUT(cpustate, cpustate->_BC, RM(cpustate, cpustate->ea)); } /* OUT (C),(HL+IX)   */
OP(dded,4a) { ADC16( IX, cpustate->_BC );                                            } /* ADC  IX,BC       */
OP(dded,4b) { illegal_2(cpustate); ed_4b(cpustate);                            } /* LD   'BC,(w)     */
OP(dded,4c) { illegal_2(cpustate); ed_4c(cpustate);                            } /* NEG  'HL         */
OP(dded,4d) { illegal_2(cpustate); ed_4d(cpustate);                            } /* RETI '           */
OP(dded,4e) { illegal_2(cpustate); ed_4e(cpustate);                            } /* IM   '3          */
OP(dded,4f) { illegal_2(cpustate); ed_4f(cpustate);                            } /* LD   'R,A        */

OP(dded,50) { union PAIR tmp; EAHY(cpustate); tmp.b.l = IN(cpustate, cpustate->_BC); WM(cpustate, cpustate->ea, tmp.b.l); cpustate->_F = (cpustate->_F & CF) | SZP[tmp.b.l]; } /* IN (HL+IY),(C)    */
OP(dded,51) { EAHY(cpustate); OUT(cpustate, cpustate->_BC, RM(cpustate, cpustate->ea)); } /* OUT (C),(HL+IY)   */
OP(dded,52) { SBC16( IX, cpustate->_DE );                                            } /* SBC  IX,DE       */
OP(dded,53) { illegal_2(cpustate); ed_53(cpustate);                            } /* LD  '(w),DE      */
OP(dded,54) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,55) { illegal_2(cpustate); ed_55(cpustate);                            } /* RETIL '          */
OP(dded,56) { illegal_2(cpustate); ed_56(cpustate);                            } /* IM   '1          */
OP(dded,57) { illegal_2(cpustate); ed_57(cpustate);                            } /* LD   'A,I        */

OP(dded,58) { union PAIR tmp; EAXY(cpustate); tmp.b.l = IN(cpustate, cpustate->_BC); WM(cpustate, cpustate->ea, tmp.b.l); cpustate->_F = (cpustate->_F & CF) | SZP[tmp.b.l]; } /* IN (IX+IY),(C)    */
OP(dded,59) { EAXY(cpustate); OUT(cpustate, cpustate->_BC, RM(cpustate, cpustate->ea)); } /* OUT (C),(IX+IY)   */
OP(dded,5a) { ADC16( IX, cpustate->_DE );                                            } /* ADC  IX,DE       */
OP(dded,5b) { illegal_2(cpustate); ed_5b(cpustate);                            } /* LD   'DE,(w)     */
OP(dded,5c) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,5d) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,5e) { illegal_2(cpustate); ed_5e(cpustate);                            } /* IM   '2          */
OP(dded,5f) { illegal_2(cpustate); ed_5f(cpustate);                            } /* LD   'A,R        */

OP(dded,60) { cpustate->_HX = IN(cpustate, cpustate->_BC); cpustate->_F = (cpustate->_F & CF) | SZP[cpustate->_HX];                 } /* IN   HX,(C)      */
OP(dded,61) { OUT(cpustate, cpustate->_BC,cpustate->_HX);                                          } /* OUT  (C),HX       */
OP(dded,62) { SBC16( IX, cpustate->_IX );                                            } /* SBC  IX,IX       */
OP(dded,63) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,64) { illegal_2(cpustate); ed_64(cpustate);                            } /* EXTS 'A          */
OP(dded,65) { illegal_2(cpustate); ed_65(cpustate);                            } /* PCACHE '         */
OP(dded,66) { LD_REG_CTL( IX );                                         } /* LDCTL IX,(C)     */
OP(dded,67) { illegal_2(cpustate); ed_67(cpustate);                            } /* RRD  '          */

OP(dded,68) { cpustate->_LX = IN(cpustate, cpustate->_BC); cpustate->_F = (cpustate->_F & CF) | SZP[cpustate->_LX];                 } /* IN   LX,(C)       */
OP(dded,69) { OUT(cpustate, cpustate->_BC,cpustate->_LX);                                          } /* OUT  (C),LX       */
OP(dded,6a) { ADC16( IX, cpustate->_IX );                                            } /* ADC  IX,IX       */
OP(dded,6b) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,6c) { illegal_2(cpustate); ed_6c(cpustate);                            } /* EXTS 'HL          */
OP(dded,6d) { ADD16_A( IX );                                          } /* ADD IX,A         */
OP(dded,6e) { LD_CTL_REG( IX );                                          } /* LDCTL (C),IX     */
OP(dded,6f) { illegal_2(cpustate); ed_6f(cpustate);                            } /* RLD  '         */

OP(dded,70) { illegal_2(cpustate); ed_70(cpustate);                            } /* TSTI '(C)         */
OP(dded,71) { illegal_2(cpustate); ed_71(cpustate);                            } /* SC  'w         */
OP(dded,72) { SBC16( IX, _SP(cpustate) );                                            } /* SBC  IX,SP       */
OP(dded,73) { illegal_2(cpustate); ed_73(cpustate);                            } /* LD  '(w),SP      */
OP(dded,74) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,75) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,76) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,77) { illegal_2(cpustate); ed_77(cpustate);                            } /* DI  'n           */

OP(dded,78) { union PAIR tmp; tmp.b.l = IN(cpustate, cpustate->_BC); WM(cpustate, ARG16(cpustate), tmp.b.l); cpustate->_F = (cpustate->_F & CF) | SZP[tmp.b.l]; } /* IN (w),(C)    */
OP(dded,79) { OUT(cpustate, cpustate->_BC, RM(cpustate, ARG16(cpustate))); } /* OUT (C),(w)   */
OP(dded,7a) { ADC16( IX, _SP(cpustate) );                                            } /* ADC  IX,SP       */
OP(dded,7b) { illegal_2(cpustate); ed_7b(cpustate);                            } /* LD  'SP,(w)      */
OP(dded,7c) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,7d) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,7e) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,7f) { illegal_2(cpustate); ed_7f(cpustate);                            } /* EI   'n          */

OP(dded,80) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,81) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,82) { illegal_2(cpustate); ed_82(cpustate);                            } /* INIW '           */
OP(dded,83) { illegal_2(cpustate); ed_83(cpustate);                            } /* OUTIW '          */
OP(dded,84) { illegal_2(cpustate); ed_84(cpustate);                            } /* EPUM '(SP+w)     */
OP(dded,85) { illegal_2(cpustate); ed_85(cpustate);                            } /* MEPU '(SP+w)     */
OP(dded,86) { EAX(cpustate); LDUD_A_M;                                        } /* LDUD A,(IX+o)    */
OP(dded,87) { cpustate->_IX = cpustate->_USP;                                 } /* LDCTL IX,USP     */

OP(dded,88) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,89) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,8a) { illegal_2(cpustate); ed_8a(cpustate);                            } /* INDW '         */
OP(dded,8b) { illegal_2(cpustate); ed_8b(cpustate);                            } /* OUTDW '         */
OP(dded,8c) { illegal_2(cpustate); ed_8c(cpustate);                            } /* EPUM '(HL+IX)   */
OP(dded,8d) { illegal_2(cpustate); ed_8d(cpustate);                            } /* MEPU '(HL+IX)   */
OP(dded,8e) { EAX(cpustate); LDUD_M_A;                                        } /* LDUD (IX+o),A    */
OP(dded,8f) { cpustate->_USP = cpustate->_IX;                                 } /* LDCTL USP,IX     */

OP(dded,90) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,91) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,92) { illegal_2(cpustate); ed_92(cpustate);                            } /* INIRW '          */
OP(dded,93) { illegal_2(cpustate); ed_93(cpustate);                            } /* OTIRW '          */
OP(dded,94) { illegal_2(cpustate); ed_94(cpustate);                            } /* EPUM '(HL+IY)     */
OP(dded,95) { illegal_2(cpustate); ed_95(cpustate);                            } /* MEPU '(HL+IY)     */
OP(dded,96) { EAX(cpustate); LDUP_A_M;                                        } /* LDUP A,(IX+o)    */
OP(dded,97) { illegal_2(cpustate); ed_97(cpustate);                            } /* EPUF '          */

OP(dded,98) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,99) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,9a) { illegal_2(cpustate); ed_9a(cpustate);                            } /* INDRW '         */
OP(dded,9b) { illegal_2(cpustate); ed_9b(cpustate);                            } /* OTDRW '          */
OP(dded,9c) { illegal_2(cpustate); ed_9c(cpustate);                            } /* EPUM '(IX+IY)     */
OP(dded,9d) { illegal_2(cpustate); ed_9d(cpustate);                            } /* EPUM '(IX+IY)     */
OP(dded,9e) { EAX(cpustate); LDUP_M_A;                                        } /* LDUP (IX+o),A    */
OP(dded,9f) { illegal_2(cpustate); ed_9f(cpustate);                            } /* EPUI '          */

OP(dded,a0) { illegal_2(cpustate); ed_a0(cpustate);                            } /* LDI '          */
OP(dded,a1) { illegal_2(cpustate); ed_a1(cpustate);                            } /* CPI '          */
OP(dded,a2) { illegal_2(cpustate); ed_a2(cpustate);                            } /* INI '          */
OP(dded,a3) { illegal_2(cpustate); ed_a3(cpustate);                            } /* OUTI '          */
OP(dded,a4) { illegal_2(cpustate); ed_a4(cpustate);                            } /* EPUM '(ra)     */
OP(dded,a5) { illegal_2(cpustate); ed_a5(cpustate);                            } /* MEPU '(ra)     */
OP(dded,a6) { illegal_2(cpustate); ed_a6(cpustate);                            } /* EPUM '(HL)     */
OP(dded,a7) { illegal_2(cpustate); ed_a7(cpustate);                            } /* EPUM '(w)     */

OP(dded,a8) { illegal_2(cpustate); ed_a8(cpustate);                            } /* LDD '          */
OP(dded,a9) { illegal_2(cpustate); ed_a9(cpustate);                            } /* CPD '          */
OP(dded,aa) { illegal_2(cpustate); ed_aa(cpustate);                            } /* IND '          */
OP(dded,ab) { illegal_2(cpustate); ed_ab(cpustate);                            } /* OUTD '          */
OP(dded,ac) { illegal_2(cpustate); ed_ac(cpustate);                            } /* EPUM '(IX+w)    */
OP(dded,ad) { illegal_2(cpustate); ed_ad(cpustate);                            } /* MEPU '(IX+w)     */
OP(dded,ae) { illegal_2(cpustate); ed_ae(cpustate);                            } /* MEPU '(HL)     */
OP(dded,af) { illegal_2(cpustate); ed_af(cpustate);                            } /* MEPU '(w)       */

OP(dded,b0) { illegal_2(cpustate); ed_b0(cpustate);                            } /* LDIR '          */
OP(dded,b1) { illegal_2(cpustate); ed_b1(cpustate);                            } /* CPIR '          */
OP(dded,b2) { illegal_2(cpustate); ed_b2(cpustate);                            } /* INIR '          */
OP(dded,b3) { illegal_2(cpustate); ed_b3(cpustate);                            } /* OTIR '          */
OP(dded,b4) { illegal_2(cpustate); ed_b4(cpustate);                            } /* EPUM '(IY+w)     */
OP(dded,b5) { illegal_2(cpustate); ed_b5(cpustate);                            } /* MEPU '(IY+w)     */
OP(dded,b6) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,b7) { illegal_2(cpustate); ed_b7(cpustate);                            } /* INW 'HL,(C)      */

OP(dded,b8) { illegal_2(cpustate); ed_b8(cpustate);                            } /* LDDR '          */
OP(dded,b9) { illegal_2(cpustate); ed_b9(cpustate);                            } /* CPDR '          */
OP(dded,ba) { illegal_2(cpustate); ed_ba(cpustate);                            } /* INDR '          */
OP(dded,bb) { illegal_2(cpustate); ed_bb(cpustate);                            } /* OTDR '          */
OP(dded,bc) { illegal_2(cpustate); ed_bc(cpustate);                            } /* EPUM '(HL+w)     */
OP(dded,bd) { illegal_2(cpustate); ed_bd(cpustate);                            } /* MEPU '(HL+w)     */
OP(dded,be) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(dded,bf) { illegal_2(cpustate); ed_bf(cpustate);                            } /* OUTW '(C),HL     */
...
OP(dded,cf) { illegal_2(cpustate);                                            } /* DB   ED          */
...
OP(dded,df) { illegal_2(cpustate);                                            } /* DB   ED          */
...
OP(dded,ef) { illegal_2(cpustate); ed_ef(cpustate);                           } /* EX 'H,L          */
...
OP(dded,ff) { illegal_2(cpustate);                                            } /* DB   ED          */
