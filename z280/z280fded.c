 ...
 **********************************************************/
OP(fded,00) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,01) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,02) { EASP16(cpustate); cpustate->_IY = cpustate->ea;                 } /* LDA IY,(SP+w)    */
OP(fded,03) { illegal_2(cpustate); ed_03(cpustate);                           } /* LD '(SP+w),A     */
...
OP(fded,08) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,09) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,0a) { EAHX(cpustate); cpustate->_IY = cpustate->ea;                   } /* LDA IY,(HL+IX)   */
OP(fded,0b) { illegal_2(cpustate); ed_0b(cpustate);                            } /* LD '(HL+IX),A    */
...
OP(fded,10) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,11) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,12) { EAHY(cpustate); cpustate->_IY = cpustate->ea;                   } /* LDA IY,(HL+IY)   */
OP(fded,13) { illegal_2(cpustate); ed_13(cpustate);                            } /* LD '(HL+IY),A    */
...
OP(fded,18) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,19) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,1a) { EAXY(cpustate); cpustate->_IY = cpustate->ea;                   } /* LDA IY,(IX+IY)   */
OP(fded,1b) { illegal_2(cpustate); ed_1b(cpustate);                            } /* LD '(IX+IY),A    */
...
OP(fded,20) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,21) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,22) { EARA(cpustate); cpustate->_IY = cpustate->ea;                   } /* LDA IY,(ra)      */
OP(fded,23) { illegal_2(cpustate); ed_23(cpustate);                            } /* LD '(ra),A       */
...
OP(fded,28) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,29) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,2a) { EAX16(cpustate); cpustate->_IY = cpustate->ea;                  } /* LDA IY,(IX+w)    */
OP(fded,2b) { illegal_2(cpustate); ed_2b(cpustate);                            } /* LD '(IX+w),A     */
...
OP(fded,30) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,31) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,32) { EAY16(cpustate); cpustate->_IY = cpustate->ea;                  } /* LDA IY,(IY+w)    */
OP(fded,33) { illegal_2(cpustate); ed_33(cpustate);                            } /* LD '(IY+w),A     */
...
OP(fded,38) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,39) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,3a) { EAH16(cpustate); cpustate->_IY = cpustate->ea;                  } /* LDA IY,(HL+w)    */
OP(fded,3b) { illegal_2(cpustate); ed_3b(cpustate);                            } /* LD '(HL+w),A     */
...
OP(fded,45) { illegal_2(cpustate); ed_45(cpustate);                            } /* RETN '           */
...
OP(fded,4d) { illegal_2(cpustate); ed_4d(cpustate);                            } /* RETI '           */
...
OP(fded,55) { illegal_2(cpustate); ed_55(cpustate);                            } /* RETIL '          */
...
OP(fded,5d) { illegal_2(cpustate);                                            } /* DB   ED          */
...
OP(fded,65) { illegal_2(cpustate); ed_65(cpustate);                            } /* PCACHE '         */
...
OP(fded,6f) { illegal_2(cpustate); ed_6f(cpustate);                            } /* RLD  '         */

OP(fded,70) { illegal_2(cpustate); ed_70(cpustate);                            } /* TSTI '(C)         */
OP(fded,71) { illegal_2(cpustate); ed_71(cpustate);                            } /* SC  'w         */
OP(fded,72) { SBC16( IY, _SP(cpustate) );                                     } /* SBC  IY,SP       */
OP(fded,73) { illegal_2(cpustate); ed_73(cpustate);                            } /* LD  '(w),SP      */
OP(fded,74) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,75) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,76) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,77) { illegal_2(cpustate); ed_77(cpustate);                            } /* DI  'n           */

OP(fded,78) { illegal_2(cpustate); ed_78(cpustate);                            } /* IN 'A,(C)       */
OP(fded,79) { illegal_2(cpustate); ed_79(cpustate);                            } /* OUT '(C),A      */
OP(fded,7a) { ADC16( IY, _SP(cpustate) );                                     } /* ADC  IY,SP       */
OP(fded,7b) { illegal_2(cpustate); ed_7b(cpustate);                            } /* LD  'SP,(w)      */
OP(fded,7c) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,7d) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,7e) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,7f) { illegal_2(cpustate); ed_7f(cpustate);                            } /* EI   'n          */

OP(fded,80) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,81) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,82) { illegal_2(cpustate); ed_82(cpustate);                            } /* INIW '           */
...
OP(fded,89) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,8a) { illegal_2(cpustate); ed_8a(cpustate);                            } /* INDW '         */
...
OP(fded,91) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,92) { illegal_2(cpustate); ed_92(cpustate);                            } /* INIRW '          */
...
OP(fded,99) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,9a) { illegal_2(cpustate); ed_9a(cpustate);                            } /* INDRW '         */
...
OP(fded,a1) { illegal_2(cpustate); ed_a1(cpustate);                            } /* CPI '          */
OP(fded,a2) { illegal_2(cpustate); ed_a2(cpustate);                            } /* INI '          */
OP(fded,a3) { illegal_2(cpustate); ed_a3(cpustate);                            } /* OUTI '          */
OP(fded,a4) { illegal_2(cpustate); ed_a4(cpustate);                            } /* EPUM '(ra)     */
OP(fded,a5) { illegal_2(cpustate); ed_a5(cpustate);                            } /* MEPU '(ra)     */
OP(fded,a6) { illegal_2(cpustate); ed_a6(cpustate);                            } /* EPUM '(HL)     */
OP(fded,a7) { illegal_2(cpustate); ed_a7(cpustate);                            } /* EPUM '(w)     */

OP(fded,a8) { illegal_2(cpustate); ed_a8(cpustate);                            } /* LDD '          */
OP(fded,a9) { illegal_2(cpustate); ed_a9(cpustate);                            } /* CPD '          */
OP(fded,aa) { illegal_2(cpustate); ed_aa(cpustate);                            } /* IND '          */
OP(fded,ab) { illegal_2(cpustate); ed_ab(cpustate);                            } /* OUTD '          */
OP(fded,ac) { illegal_2(cpustate); ed_ac(cpustate);                            } /* EPUM '(IX+w)    */
OP(fded,ad) { illegal_2(cpustate); ed_ad(cpustate);                            } /* MEPU '(IX+w)     */
OP(fded,ae) { illegal_2(cpustate); ed_ae(cpustate);                            } /* MEPU '(HL)     */
OP(fded,af) { illegal_2(cpustate); ed_af(cpustate);                            } /* MEPU '(w)       */

OP(fded,b0) { illegal_2(cpustate); ed_b0(cpustate);                            } /* LDIR '          */
OP(fded,b1) { illegal_2(cpustate); ed_b1(cpustate);                            } /* CPIR '          */
OP(fded,b2) { illegal_2(cpustate); ed_b2(cpustate);                            } /* INIR '          */
OP(fded,b3) { illegal_2(cpustate); ed_b3(cpustate);                            } /* OTIR '          */
OP(fded,b4) { illegal_2(cpustate); ed_b4(cpustate);                            } /* EPUM '(IY+w)     */
OP(fded,b5) { illegal_2(cpustate); ed_b5(cpustate);                            } /* MEPU '(IY+w)     */
OP(fded,b6) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,b7) { illegal_2(cpustate); ed_b7(cpustate);                            } /* INW 'HL,(C)      */

OP(fded,b8) { illegal_2(cpustate); ed_b8(cpustate);                            } /* LDDR '          */
OP(fded,b9) { illegal_2(cpustate); ed_b9(cpustate);                            } /* CPDR '          */
OP(fded,ba) { illegal_2(cpustate); ed_ba(cpustate);                            } /* INDR '          */
OP(fded,bb) { illegal_2(cpustate); ed_bb(cpustate);                            } /* OTDR '          */
OP(fded,bc) { illegal_2(cpustate); ed_bc(cpustate);                            } /* EPUM '(HL+w)     */
OP(fded,bd) { illegal_2(cpustate); ed_bd(cpustate);                            } /* MEPU '(HL+w)     */
OP(fded,be) { illegal_2(cpustate);                                            } /* DB   ED          */
OP(fded,bf) { illegal_2(cpustate); ed_bf(cpustate);                            } /* OUTW '(C),HL     */
...
OP(fded,cf) { illegal_2(cpustate);                                            } /* DB   ED          */
...
OP(fded,df) { illegal_2(cpustate);                                            } /* DB   ED          */
...
OP(fded,ef) { illegal_2(cpustate); ed_ef(cpustate);                           } /* EX 'H,L          */
...
OP(fded,ff) { illegal_2(cpustate);                                            } /* DB   ED          */
