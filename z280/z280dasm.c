...
enum e_mnemonics {
	...
	zDJNZ  ,zEI    ,zEX    ,zEXTS  ,zEXX   ,zHLT   ,zIM    ,zIN    ,zINW   ,
...
static const char *const s_mnemonic[] = {
	...
	"div"  ,"divu" ,"divuw","divw" ,
	"djnz" ,"ei"   ,"ex"   ,"exts" ,"exx"  ,"halt" ,"im"   ,"in"   ,"inw"  ,
...
static const struct z80dasm mnemonic_xx_cb[256]= {
	{zRLC,"'X"},   {zRLC,"'X"},   {zRLC,"'X"},   {zRLC,"'X"},
	{zRLC,"'X"},   {zRLC,"'X"},   {zRLC,"X"},     {zRLC,"'X"},
	{zRRC,"'X"},   {zRRC,"'X"},   {zRRC,"'X"},   {zRRC,"'X"},
	{zRRC,"'X"},   {zRRC,"'X"},   {zRRC,"X"},     {zRRC,"'X"},
	{zRL,"'X"},    {zRL,"'X"},    {zRL,"'X"},    {zRL,"'X"},
	{zRL,"'X"},    {zRL,"'X"},    {zRL,"X"},      {zRL,"'X"},
	{zRR,"'X"},    {zRR,"'X"},    {zRR,"'X"},    {zRR,"'X"},
	{zRR,"'X"},    {zRR,"'X"},    {zRR,"X"},      {zRR,"'X"},
	{zSLA,"'X"},   {zSLA,"'X"},   {zSLA,"'X"},   {zSLA,"'X"},
	{zSLA,"'X"},   {zSLA,"'X"},   {zSLA,"X"},     {zSLA,"'X"},
	{zSRA,"'X"},   {zSRA,"'X"},   {zSRA,"'X"},   {zSRA,"'X"},
	{zSRA,"'X"},   {zSRA,"'X"},   {zSRA,"X"},     {zSRA,"'X"},
	{zTSET,"'X"},  {zTSET,"'X"},  {zTSET,"'X"},  {zTSET,"'X"},
	{zTSET,"'X"},  {zTSET,"'X"},  {zTSET,"X"},    {zTSET,"'X"},
	{zSRL,"'X"},   {zSRL,"'X"},   {zSRL,"'X"},   {zSRL,"'X"},
	{zSRL,"'X"},   {zSRL,"'X"},   {zSRL,"X"},     {zSRL,"'X"},
	{zBIT,"'0,X"}, {zBIT,"'0,X"}, {zBIT,"'0,X"}, {zBIT,"'0,X"},
	{zBIT,"'0,X"}, {zBIT,"'0,X"}, {zBIT,"0,X"},   {zBIT,"'0,X"},
	{zBIT,"'1,X"}, {zBIT,"'1,X"}, {zBIT,"'1,X"}, {zBIT,"'1,X"},
	{zBIT,"'1,X"}, {zBIT,"'1,X"}, {zBIT,"1,X"},   {zBIT,"'1,X"},
	{zBIT,"'2,X"}, {zBIT,"'2,X"}, {zBIT,"'2,X"}, {zBIT,"'2,X"},
	{zBIT,"'2,X"}, {zBIT,"'2,X"}, {zBIT,"2,X"},   {zBIT,"'2,X"},
	{zBIT,"'3,X"}, {zBIT,"'3,X"}, {zBIT,"'3,X"}, {zBIT,"'3,X"},
	{zBIT,"'3,X"}, {zBIT,"'3,X"}, {zBIT,"3,X"},   {zBIT,"'3,X"},
	{zBIT,"'4,X"}, {zBIT,"'4,X"}, {zBIT,"'4,X"}, {zBIT,"'4,X"},
	{zBIT,"'4,X"}, {zBIT,"'4,X"}, {zBIT,"4,X"},   {zBIT,"'4,X"},
	{zBIT,"'5,X"}, {zBIT,"'5,X"}, {zBIT,"'5,X"}, {zBIT,"'5,X"},
	{zBIT,"'5,X"}, {zBIT,"'5,X"}, {zBIT,"5,X"},   {zBIT,"'5,X"},
	{zBIT,"'6,X"}, {zBIT,"'6,X"}, {zBIT,"'6,X"}, {zBIT,"'6,X"},
	{zBIT,"'6,X"}, {zBIT,"'6,X"}, {zBIT,"6,X"},   {zBIT,"'6,X"},
	{zBIT,"'7,X"}, {zBIT,"'7,X"}, {zBIT,"'7,X"}, {zBIT,"'7,X"},
	{zBIT,"'7,X"}, {zBIT,"'7,X"}, {zBIT,"7,X"},   {zBIT,"'7,X"},
	{zRES,"'0,X"}, {zRES,"'0,X"}, {zRES,"'0,X"}, {zRES,"'0,X"},
	{zRES,"'0,X"}, {zRES,"'0,X"}, {zRES,"0,X"},   {zRES,"'0,X"},
	{zRES,"'1,X"}, {zRES,"'1,X"}, {zRES,"'1,X"}, {zRES,"'1,X"},
	{zRES,"'1,X"}, {zRES,"'1,X"}, {zRES,"1,X"},   {zRES,"'1,X"},
	{zRES,"'2,X"}, {zRES,"'2,X"}, {zRES,"'2,X"}, {zRES,"'2,X"},
	{zRES,"'2,X"}, {zRES,"'2,X"}, {zRES,"2,X"},   {zRES,"'2,X"},
	{zRES,"'3,X"}, {zRES,"'3,X"}, {zRES,"'3,X"}, {zRES,"'3,X"},
	{zRES,"'3,X"}, {zRES,"'3,X"}, {zRES,"3,X"},   {zRES,"'3,X"},
	{zRES,"'4,X"}, {zRES,"'4,X"}, {zRES,"'4,X"}, {zRES,"'4,X"},
	{zRES,"'4,X"}, {zRES,"'4,X"}, {zRES,"4,X"},   {zRES,"'4,X"},
	{zRES,"'5,X"}, {zRES,"'5,X"}, {zRES,"'5,X"}, {zRES,"'5,X"},
	{zRES,"'5,X"}, {zRES,"'5,X"}, {zRES,"5,X"},   {zRES,"'5,X"},
	{zRES,"'6,X"}, {zRES,"'6,X"}, {zRES,"'6,X"}, {zRES,"'6,X"},
	{zRES,"'6,X"}, {zRES,"'6,X"}, {zRES,"6,X"},   {zRES,"'6,X"},
	{zRES,"'7,X"}, {zRES,"'7,X"}, {zRES,"'7,X"}, {zRES,"'7,X"},
	{zRES,"'7,X"}, {zRES,"'7,X"}, {zRES,"7,X"},   {zRES,"'7,X"},
	{zSET,"'0,X"}, {zSET,"'0,X"}, {zSET,"'0,X"}, {zSET,"'0,X"},
	{zSET,"'0,X"}, {zSET,"'0,X"}, {zSET,"0,X"},   {zSET,"'0,X"},
	{zSET,"'1,X"}, {zSET,"'1,X"}, {zSET,"'1,X"}, {zSET,"'1,X"},
	{zSET,"'1,X"}, {zSET,"'1,X"}, {zSET,"1,X"},   {zSET,"'1,X"},
	{zSET,"'2,X"}, {zSET,"'2,X"}, {zSET,"'2,X"}, {zSET,"'2,X"},
	{zSET,"'2,X"}, {zSET,"'2,X"}, {zSET,"2,X"},   {zSET,"'2,X"},
	{zSET,"'3,X"}, {zSET,"'3,X"}, {zSET,"'3,X"}, {zSET,"'3,X"},
	{zSET,"'3,X"}, {zSET,"'3,X"}, {zSET,"3,X"},   {zSET,"'3,X"},
	{zSET,"'4,X"}, {zSET,"'4,X"}, {zSET,"'4,X"}, {zSET,"'4,X"},
	{zSET,"'4,X"}, {zSET,"'4,X"}, {zSET,"4,X"},   {zSET,"'4,X"},
	{zSET,"'5,X"}, {zSET,"'5,X"}, {zSET,"'5,X"}, {zSET,"'5,X"},
	{zSET,"'5,X"}, {zSET,"'5,X"}, {zSET,"5,X"},   {zSET,"'5,X"},
	{zSET,"'6,X"}, {zSET,"'6,X"}, {zSET,"'6,X"}, {zSET,"'6,X"},
	{zSET,"'6,X"}, {zSET,"'6,X"}, {zSET,"6,X"},   {zSET,"'6,X"},
	{zSET,"'7,X"}, {zSET,"'7,X"}, {zSET,"'7,X"}, {zSET,"'7,X"},
	{zSET,"'7,X"}, {zSET,"'7,X"}, {zSET,"7,X"},   {zSET,"'7,X"}
};
...
static const struct z80dasm mnemonic_dd_ed[256]= {
	...
	{zDB,"?"},      {zDB,"?"},      {zLDUD,"a,X"},{zLDCTL,"I,usp"},
	{zDB,"?"},      {zDB,"?"},      {zINDW,"'"},      {zOUTDW,"'"},
	{zDB,"?"},      {zDB,"?"},      {zLDUD,"X,a"},{zLDCTL,"usp,I"},
	{zDB,"?"},      {zDB,"?"},      {zINIRW,"'"},     {zOTIRW,"'"},
	{zDB,"?"},      {zDB,"?"},      {zLDUP,"a,X"},{zDB,"?"},
	{zDB,"?"},      {zDB,"?"},      {zINDRW,"'"},     {zOTDRW,"'"},
	{zDB,"?"},      {zDB,"?"},      {zLDUP,"X,a"},{zDB,"?"},
